...
/* 	if (navigator.connection.type == Connection.NONE) { // error qr code not found
		...
		cordova.plugins.barcodeScanner.scan(function(result){ // success callback
			...
			if(result.cancelled) {
				document.getElementById('icon').innerHTML = '<img src="img/icon-error.png"/>';
...
function ok(data){
	// document.getElementById('icon').innerHTML = '<img src="img/icon-ok.png"/>';
	// document.getElementById('home').innerHTML = '<img src="img/icon-app-big.png" height="100%" alt="home" />';
	// document.getElementById('result').innerHTML = 
...
function warning(data){
	// document.getElementById('home').innerHTML = '<img src="img/icon-app-big.png" height="100%" alt="home" />';
	// document.getElementById('icon').innerHTML = '<img src="img/icon-warning.png"/>';
	// document.getElementById('result').innerHTML = 
...
function onOffline(){
	document.getElementById('icon').innerHTML = '<img src="img/icon-offline.png"/>';
...
function onOnline(){
	document.getElementById('icon').innerHTML = '<img src="img/icon-scan.png"/>';
	scan();
}
